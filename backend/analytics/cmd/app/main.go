...
import (
	...
	"golang-coursework/backend/analytics/internal/app"
	"golang-coursework/backend/analytics/pkg/logger"
)

func main() {
	configPath := flag.String("configPath", "backend/analytics/config/config-analytics.yaml", "Path to the config file")
	flag.Parse()
